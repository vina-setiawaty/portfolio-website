  ...
  return (
    <div className="font-secondary bg-primary text-accent flex flex-col min-h-screen items-start justify-start">
      ...
      <div className="flex flex-col items-center justify-start min-h-screen max-w-[2160px] w-full my-[52px] md:my-[80px]">
        <div className="flex flex-col items-center justify-start min-h-screen max-w-[2160px] w-full my-[48px] gap-4">
          ...
          <h2 className="text-lg md:text-2xl text-center font-secondary text-accent mb-8 mx-[12px] md:mx-[48px] max-w-[1280px]">
